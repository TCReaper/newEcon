...
import styles from "./NewEntrySOAFilled.module.css";
const NewEntrySOAFilled = () => {
  ...
  return (
    <div className={styles.newEntrySoaFilled}>
        ...
        <div className={styles.contentHolder}>
          <div className={styles.content}>
            <div className={styles.photo}>
              <img
                className={styles.img7208b92e888811Icon}
                alt=""
                src="/img-7208b92e88881-1@2x.png"
              />
            </div>
            <div className={styles.input} />
            <div className={styles.supplier}>Supplier</div>
            <div
              className={styles.shengShengFb}
            >{`SHENG SHENG F&B INDUSTRIES PTE LTD`}</div>
            ...
            <div className={styles.div}>$ 63.56</div>
            <div className={styles.div1}>$ 59.40</div>
            ...
            <div className={styles.productList1}>
              ...
              <div className={styles.input1}>
                <div className={styles.mejiFreshMilk}>1</div>
              </div>
              <div className={styles.input2}>
                <div className={styles.mejiFreshMilk}>220104</div>
              </div>
              <div className={styles.input3}>
                <div className={styles.mejiFreshMilk}>
                  Meji Fresh Milk 2 Litres
                </div>
              </div>
              <div className={styles.input4}>
                <div className={styles.mejiFreshMilk}>4.95</div>
              </div>
              <div className={styles.input5}>
                <div className={styles.mejiFreshMilk}>59.40</div>
              </div>
              <div className={styles.input6}>
                <div className={styles.mejiFreshMilk}>12</div>
              </div>
            </div>
            <div className={styles.input7}>
              <div className={styles.mejiFreshMilk}>23/04/2023</div>
            </div>
            ...
            <div className={styles.newEntryInvoiceContainer}>
              <p className={styles.newEntry}>New Entry:</p>
...
export default NewEntrySOAFilled;
